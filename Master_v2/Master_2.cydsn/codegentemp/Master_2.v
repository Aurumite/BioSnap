...
module BLE_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("c7b24ba1-5ecb-4985-90e5-85912854ac1f/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module ADC_SAR_SEQ_P4_v2_40_2 (
	...
	cy_clock_v1_0
		#(.id("15dbad23-82b6-44c9-b139-488d076b9be5/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("906a168e-d15e-4c56-9303-f8c3992da0a7"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__temp_in_net;
	wire [0:0] tmpFB_0__temp_in_net;
	wire [0:0] tmpIO_0__temp_in_net;
	wire [0:0] tmpINTERRUPT_0__temp_in_net;
	electrical [0:0] tmpSIOVREF__temp_in_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		temp_in
		 (.oe(tmpOE__temp_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__temp_in_net[0:0]}),
		  .analog({Net_133}),
		  .io({tmpIO_0__temp_in_net[0:0]}),
		  .siovref(tmpSIOVREF__temp_in_net),
		  .interrupt({tmpINTERRUPT_0__temp_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__temp_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_3 Timer_minute (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__bat_in_net;
	wire [0:0] tmpFB_0__bat_in_net;
	wire [0:0] tmpIO_0__bat_in_net;
	wire [0:0] tmpINTERRUPT_0__bat_in_net;
	electrical [0:0] tmpSIOVREF__bat_in_net;

	cy_psoc3_pins_v1_10
		#(.id("8c574d91-4ddb-4c92-b145-6ee2da1918a1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		bat_in
		 (.oe(tmpOE__bat_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__bat_in_net[0:0]}),
		  .analog({Net_383}),
		  .io({tmpIO_0__bat_in_net[0:0]}),
		  .siovref(tmpSIOVREF__bat_in_net),
		  .interrupt({tmpINTERRUPT_0__bat_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__bat_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BAdvertLED_net;
	wire [0:0] tmpFB_0__BAdvertLED_net;
	wire [0:0] tmpIO_0__BAdvertLED_net;
	wire [0:0] tmpINTERRUPT_0__BAdvertLED_net;
	electrical [0:0] tmpSIOVREF__BAdvertLED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		BAdvertLED
		 (.oe(tmpOE__BAdvertLED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BAdvertLED_net[0:0]}),
		  .io({tmpIO_0__BAdvertLED_net[0:0]}),
		  .siovref(tmpSIOVREF__BAdvertLED_net),
		  .interrupt({tmpINTERRUPT_0__BAdvertLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BAdvertLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
