...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* BioSnap service */
    {
        0x000Eu, /* Handle of the BioSnap service */ 
        {

            /* Accelerometer characteristic */
            {
                0x0010u, /* Handle of the Accelerometer characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0011u, /* Handle of the AccelCCC descriptor */ 
                }, 
            },

            /* Battery characteristic */
            {
                0x0013u, /* Handle of the Battery characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0014u, /* Handle of the BatCCC descriptor */ 
                }, 
            },
